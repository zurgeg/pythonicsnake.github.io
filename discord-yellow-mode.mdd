# Discord Yellow Mode
A little client mode I made for Discord, does not support BD or PowerCord, simply paste this into the inspect element panel
```js
document.getElementsByTagName("head")[0].innerHTML += `<style>.theme-light {
    ...
    --background-secondary: #ffeb00eb;
    --background-secondary-alt: #ffeb00d9;
    --background-tertiary: #ffeb00c1;
    --background-accent: #747f8d;
    --background-floating: #ffeb00;
    --background-mobile-primary: #ffeb00;
    --background-mobile-secondary: #ffeb00;
